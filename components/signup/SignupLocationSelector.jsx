...
const HorizontalOptions = ({ items, selectedId, getLabel, onSelect }) => (
    ...
    <View style={{ marginBottom: 16 }}>
      ...
      {selectedCity && (
        <View style={{ marginBottom: 12 }}>
          ...
          {loadingLocations ? (
            ...
            <HorizontalOptions
              items={suburbs}
              selectedId={selectedSuburb?.id}
              getLabel={(suburb) => suburb.name}
        ...
        <View style={{ marginBottom: 12 }}>
          ...
          {loadingLocations ? (
            ...
            <HorizontalOptions
              ...
              getLabel={(ward) => `Ward ${ward.ward_number}`}
      ...
      <View style={{ marginBottom: 12 }}>
        ...
        <TextInput
          ...
          onChangeText={onManualWardNumberChange}
